...
const focusedIsMenu = await page.evaluate(() => document.activeElement.closest('.qmenu') !== null);
ok('Enter opens Add-to menu with focus inside', focusedIsMenu);
...
await page.waitForFunction(() => !document.querySelector('#undo').disabled, null, { timeout: 15000 });
...
await page.waitForFunction(() => !document.querySelector('#redo').disabled, null, { timeout: 15000 });
