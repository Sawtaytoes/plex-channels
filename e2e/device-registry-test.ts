...
const SHIELD_ROW: PlexTvRow = {
  ...
  connections: [{ uri: 'http://10.1.0.50:32500' }],
};
...
const POLLY_ROW: PlexTvRow = {
  ...
  connections: [{ uri: 'http://10.1.0.213:53833' }],
};
const SERVER_ROW: PlexTvRow = { name: 'storeman', clientIdentifier: 'pms-machine-id', provides: 'server' };
...
// --- 1. a full sweep: the Shield plus every plex.tv player -------------------------- //
{
  ...
  ok('the Shield borrows the id/uri plex.tv knows',
    ...
    && shield?.payload.uri === 'http://10.1.0.50:32500');
