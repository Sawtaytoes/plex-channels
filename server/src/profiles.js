...
export function setForProfile(title) {
...
export async function waitForProfile({ timeout = null, cancel = null, poll = 0.5, match = null } = {}) {
  ...
  try {
    ...
    console.log(`[profiles] cannot open ${path}: ${e.message}`);
    return null;
  }
